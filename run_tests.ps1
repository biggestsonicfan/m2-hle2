...
foreach ($t in "mem_test","i960_test","rom_test","emu_test","boot_test","cop_test","geo_test","m68k_test","input_test","net_test","tile_test","heat_test","scsp_dsp_test","scsp_dsp_test_masks","ps3net_test","retro_shader_test","sfight_settings_test") {
